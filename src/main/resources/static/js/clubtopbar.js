...
! function(t, e) {
    ...
    var Ot = "dropdown",
        ...
        Ft = function() {
            function t(t, e) {
                this._element = t, this._popper = null, this._config = this._getConfig(e), this._menu = this._getMenuElement(), this._innavbar2 = this._detectnavbar2(), this._addEventListeners()
            }
            var e = t.prototype;
            return e.toggle = function() {
                ...
                this._innavbar2 = this._detectnavbar2(), null !== this._popper && this._popper.scheduleUpdate()
            }, e._addEventListeners = function() {
                var t = this;
            ...
            }, e._detectnavbar2 = function() {
                return i.default(this._element).closest(".navbar2").length > 0
