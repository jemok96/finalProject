...
public class DocumentController {
	...
	public String clubDocumentlist(@PathVariable("clno")int clno,Model model, @RequestParam(name = "cp", defaultValue = "1")int currentPage) {
	...
	public String deleteOne(@RequestParam("dno")int dno
							,@PathVariable("clno")int clno) {
		service.remove(dno);
	...
	/*
	 * @GetMapping("/{clno}/document/write") public String
	 * writeForm(@PathVariable("clno")int clno) {
	 * 
	 * }
	 */
